...
- **Team:** Kader zusammenstellen, Startelf in acht Formationen aufstellen (Positions-Eignung farbig markiert) und auswerten – Ø Overall, Altersschnitt, Wachstumsreserve, Stärke je Mannschaftsteil, Warnung bei Unterbesetzung.
- **Jugend:** eigene Akademie-Spieler mit Werten und Potenzial pflegen (auch als Bereich, wenn nur der Scout-Text bekannt ist), Entwicklung über Saisons verfolgen und mit der Datenbank vergleichen.
